...
from src.utils.utils_geom import poseRt, add_ones, add_ones_1D
...
class Map(object):
    ...
    def add_points(self, points3d, mask_pts3d, kf1, kf2, idxs1, idxs2, img1, do_check=True, cos_max_parallax=Parameters.kCosMaxParallax):
        with self._lock:             
            ...
            ratio_scale_consistency = Parameters.kScaleConsistencyFactor #* scale
    ...
    '''
    因为 import optimizer_g2o.py 出现错误，所以先干掉这一段 
