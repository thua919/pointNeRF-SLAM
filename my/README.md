...
<p align="center">
  ...
  <h1 align="center"><img src="media/logo.png" width="60">SNLAM: Simultanuosly NeRFing out Location And Map</h1>
  <p align="center">
    <a href="https://zzh2000.github.io"><strong>Tongyan Hua*</strong></a>
    ·
    <a href="https://pengsongyou.github.io"><strong>B*</strong></a>
    ·
    <a href="http://people.inf.ethz.ch/vlarsson/"><strong>C</strong></a>
    ·
    <a href="http://www.cad.zju.edu.cn/home/weiweixu/weiweixu_en.htm"><strong>D</strong></a>
...
For linux, you firstly need to install **libopenexr-dev**. We recommend using conda to install the environment. You can install the environment called `pointNeRF-SLAM` in the remote server by following command.

```bash
sudo apt-get install libopenexr-dev
conda env create -f environment.yaml
conda activate pointNeRF-SLAM
```
## Dataset
...
## Quick run
Firstly, you need to configurate the  `device:` in  `configs/point_slam/point_slam.yaml` to allocate your GPU resource. Idealy the `mapping:` and `tracking:` should be placed on different devices, e.g. `device: "cuda:3"` and `device: "cuda:5"`, but the code can run on the same devices anyway.

```bash
python pointNeRF-SLAM/run.py pointNeRF-SLAM/configs/point_slam/Replica/room0_point.yaml
```
